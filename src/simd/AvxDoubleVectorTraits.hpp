/**
	...
	AvxDoubleVectorTraits.hpp
	File with helper struct with definitions of various AVX SIMD operations.
...
#ifndef _AVX_DOUBLE_VECTOR_TRAITS_HPP_
#define _AVX_DOUBLE_VECTOR_TRAITS_HPP_

#include <immintrin.h>
#include "VectorTypeTraitsBase.hpp"

struct SseDoubleVectorTraits;

struct AvxDoubleVectorTraits : public VectorTypeTraitsBase<AvxDoubleVectorTraits>
{
	typedef double ElementType;
	typedef __m256d VectorType;
	
	typedef __m128d HalfVectorType;
	typedef SseDoubleVectorTraits HalfVectorTraits;
	...
	static const size_t DataAlignment = 32;
	...
	static VectorType set(const ElementType A, const ElementType B, const ElementType C, const ElementType D)
	{
...
#endif // _AVX_DOUBLE_VECTOR_TRAITS_HPP_
